...
### Zolon Tech Inc. / Homelab

<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Homelab Infrastructure and Documentation</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2023 – Present</em>
  </div>
...
- Identify root causes via log analysis and error research; document solutions.  
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Networking and Zero-Trust Architecture</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2025 – Present</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Vulnerability and Compliance Management</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2025 – Present</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Self-Hosted Services and Monitoring</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2025 – Present</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Cybersecurity Assessment</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2022</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Advanced Network and Server Configuration</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2022</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Network Infrastructure Design</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2021</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Network Case Analysis</strong>
  </div>
  <div style="align-self: flex-start;">
    <em>2021</em>
  </div>
...
| **Vulnerability & Compliance**| Nessus, OpenVAS, SCAP/OSCAP, DISA STIGs, CIS Benchmarks                           |
...
| **Security Frameworks & Standards**| MITRE ATT&CK, NIST, GDPR, HIPAA                                                     |
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <strong>Old Dominion University</strong>
    <div>Bachelor of Science in Cybersecurity</div>
  </div>
  <div style="align-self: flex-start;">
    <em>2022</em>
  </div>
...
<div style="display: flex; justify-content: space-between; align-items: flex-start;">
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    ...
    <div><em>CompTIA</em></div>
  </div>
  <div style="align-self: flex-start;">
    <em>Expected 11/2025</em>
  </div>
</div>
